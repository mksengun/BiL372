...
public class MH3 extends JFrame {
  ...
  private JPanel contentPane;
	...
	public MH3() {
		...
		JMenuItem mnİtmNewMenuItem = new JMenuItem("Oturumu Kapat");
		mnİtmNewMenuItem.addActionListener(new ActionListener() {
...
public void actionPerformed(ActionEvent ae){
	...
	m.setVisible(true);;}
		...
		buttonGroup.add(chckbxTamamland);
		
		final JCheckBox chckbxTamamlanmad = new JCheckBox("Tamamlanmad\u0131");
		buttonGroup.add(chckbxTamamlanmad);
		...
		buttonGroup_1.add(checkBox_2);
		
		final JCheckBox checkBox_3 = new JCheckBox("Tamamlanmad\u0131");
		buttonGroup_2.add(checkBox_3);
		...
		btnKaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if ( /*textField.getText().length()>0 && */ (chckbxTamamland.isSelected() && !(list.isSelectionEmpty())) )
					JOptionPane.showMessageDialog(null, "Ara onaylandİ.");
				
				else
					JOptionPane.showMessageDialog(null, "Lutfen ara seiniz veya durumu kontrol ediniz!");
		...
		JButton btnOnayla_1 = new JButton("Onayla");
		btnOnayla_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if ( (checkBox_1.isSelected() && !(list.isSelectionEmpty())))
					JOptionPane.showMessageDialog(null, "Ara kaydedildi.");
				else
					JOptionPane.showMessageDialog(null, "Lutfen aİklama giriniz veya durumu kontrol ediniz!");
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED, 31, Short.MAX_VALUE)
							.addComponent(btnOnayla, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(textField_2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED, 31, Short.MAX_VALUE)
							.addComponent(btnOnayla_1, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
